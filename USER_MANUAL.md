...
## Table of Contents
1. [Create Task Screen](#create-task-screen)
2. [Task List Screen](#task-list-screen)
...
- This generates an Excel file of your completed tasks and uploads it to Google Drive.
- You will receive a link to view the file upon success.

#### Screenshots
- Tap the **Camera Icon** in the top header to save an image of your current task list.
...
- **Screenshot**: Use the camera icon in the header to capture your schedule.
...
- **Currency Selector**: Tap the button (e.g., "$ US Dollar") to switch views between currencies.
- **Total Billing**: Displays the total amount for the selected currency.
- **Monthly Chart**: A bar graph showing your spending trends over recent months.
- **Category Breakdown**: A pie chart visualizing where your money is going (if categories are used).
...
### Actions
- **Screenshot**: Tap the camera icon to save your productivity report.
...
This advanced feature is designed for developers or users who want to document their usage.
- **Device Size**: Select a target device (e.g., iPhone 15 Pro, Pixel 8) to simulate the screenshot resolution.
- **Captured Screenshots**: A list of all screenshots you have taken during this session.
- **Upload to Drive**: Tap the green button to batch upload all captured images to Google Drive.
- **Clear All**: Remove all captured screenshots from the temporary list.
...
- **About**: Displays the app version (1.0.0), credits, and copyright information.
    - *Created by*: Bela Hajzer.

### Actions
- **Screenshot**: Tap the camera icon in the header to capture the settings screen itself.
